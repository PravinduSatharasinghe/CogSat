...
OUTPUT_DIR = Path("logs/FedProx_DRL")
...
def build_clients(num_clients: int) -> list[FedProxClient]:
    clients = []
...
class FLSelectorEnv(ClientSelectorEnv):
    ...
    def step(self, action: np.ndarray):
        ...
        round_log["method"] = "FedProx + DDPG selection"
...
def main():
    ...
    try:
        print("Starting FedProx training with DDPG selector...")
        print(
        ...
        print("FedProx + DDPG training complete.")
